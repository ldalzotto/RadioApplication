...
class MusicController {
  ...
  def getAllMusicUrls(@PathVariable("username") username: String): ResponseEntity[UserMusicStatusDTO] = ResponseEntity.ok(iMusicService.getMusicStatusOfCurrentClient(username))
